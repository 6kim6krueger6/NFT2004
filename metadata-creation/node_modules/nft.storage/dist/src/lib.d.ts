...
export type Service = import('../../src/lib/interface.js').Service;
export type CIDString = import('../../src/lib/interface.js').CIDString;
export type Deal = import('../../src/lib/interface.js').Deal;
export type FileObject = import('../../src/lib/interface.js').FileObject;
export type FilesSource = import('../../src/lib/interface.js').FilesSource;
export type Pin = import('../../src/lib/interface.js').Pin;
export type CarReader = import('../../src/lib/interface.js').CarReader;
export type BlockstoreI = import('ipfs-car/blockstore').Blockstore;
export type RateLimiter = import('../../src/lib/interface.js').RateLimiter;
export type RequestOptions = import('../../src/lib/interface.js').RequestOptions;
export type TokenType<T extends import("../../src/lib/interface.js").TokenInput> = import('../../src/lib/interface.js').Token<T>;
/**
...
export class NFTStorage implements Service {
     ...
     */
    static storeBlob(service: Service, blob: Blob, options?: import("../../src/lib/interface.js").RequestOptions | undefined): Promise<CIDString>;
    /**
     ...
     * @returns {Promise<CIDString>}
     */
    static storeCar({ endpoint, rateLimiter, ...token }: Service, car: Blob | CarReader, { onStoredChunk, maxRetries, maxChunkSize, decoders, signal }?: import("../../src/lib/interface.js").CarStorerOptions | undefined): Promise<CIDString>;
    /**
     ...
     * @returns {Promise<CIDString>}
     */
    static storeDirectory(service: Service, filesSource: FilesSource, options?: import("../../src/lib/interface.js").RequestOptions | undefined): Promise<CIDString>;
    /**
     ...
     */
    static store<T_1 extends import("../../src/lib/interface.js").TokenInput>(service: Service, metadata: T_1, options?: import("../../src/lib/interface.js").RequestOptions | undefined): Promise<import("../../src/lib/interface.js").Token<T_1>>;
    /**
     ...
     */
    static status({ endpoint, rateLimiter, ...token }: Service, cid: string, options?: import("../../src/lib/interface.js").RequestOptions | undefined): Promise<import('../../src/lib/interface.js').StatusResult>;
    /**
     ...
     */
    static check({ endpoint, rateLimiter }: import('../../src/lib/interface.js').PublicService, cid: string, options?: import("../../src/lib/interface.js").RequestOptions | undefined): Promise<import('../../src/lib/interface.js').CheckResult>;
    /**
     ...
     */
    static delete({ endpoint, rateLimiter, ...token }: Service, cid: string, options?: import("../../src/lib/interface.js").RequestOptions | undefined): Promise<void>;
    /**
     ...
     */
    static encodeNFT<T_2 extends import("../../src/lib/interface.js").TokenInput>(input: T_2): Promise<{
        cid: CID;
        token: import("../../src/lib/interface.js").Token<T_2>;
        car: CarReader;
    }>;
    /**
     ...
     * @readonly
     */
    readonly rateLimiter: import("../../src/lib/interface.js").RateLimiter;
    /**
     * @readonly
     */
     ...
     * @param {RequestOptions} [options]
     */
    storeBlob(blob: Blob, options?: import("../../src/lib/interface.js").RequestOptions | undefined): Promise<import("../../src/lib/interface.js").CIDString>;
    /**
     ...
     * @param {import('./lib/interface.js').CarStorerOptions} [options]
     */
    storeCar(car: Blob | CarReader, options?: import("../../src/lib/interface.js").CarStorerOptions | undefined): Promise<import("../../src/lib/interface.js").CIDString>;
    /**
     ...
     * @param {RequestOptions} [options]
     */
    storeDirectory(files: FilesSource, options?: import("../../src/lib/interface.js").RequestOptions | undefined): Promise<import("../../src/lib/interface.js").CIDString>;
    /**
     * Returns current status of the stored NFT by its CID. Note the NFT must
     * have previously been stored by this account.
     *
     ...
     * @param {RequestOptions} [options]
     */
    status(cid: string, options?: import("../../src/lib/interface.js").RequestOptions | undefined): Promise<import("../../src/lib/interface.js").StatusResult>;
    /**
     ...
     * @param {RequestOptions} [options]
     */
    delete(cid: string, options?: import("../../src/lib/interface.js").RequestOptions | undefined): Promise<void>;
    /**
     ...
     * @param {RequestOptions} [options]
     */
    check(cid: string, options?: import("../../src/lib/interface.js").RequestOptions | undefined): Promise<import("../../src/lib/interface.js").CheckResult>;
    /**
     * Stores the given token and all resources it references (in the form of a
     ...
     * @param {RequestOptions} [options]
     */
    store<T extends import("../../src/lib/interface.js").TokenInput>(token: T, options?: import("../../src/lib/interface.js").RequestOptions | undefined): Promise<import("../../src/lib/interface.js").Token<T>>;
}
import { File } from '../../src/platform.js';
import { Blob } from '../../src/platform.js';
import { FormData } from '../../src/platform.js';
import { toGatewayURL } from '../../src/gateway.js';
